...
public class ConsumerController {
    ...
    public Object addConsumer(Consumer consumer){
        ...
        Consumer consumer1 = iConsumerService.getOne(queryWrapper);
        if(consumer1!=null){
            jsonObject.put(Consts.CODE,0);
        ...
        boolean flag = iConsumerService.save(consumer);
        if(flag){ //保存成功
    ...
    public Object updateConsumer(Consumer consumer){
        ...
        boolean flag = iConsumerService.updateById(consumer);
        if(flag){   //保存成功
            jsonObject.put(Consts.CODE,1);
    ...
    public Object deleteConsumer(Integer id){
        return  iConsumerService.removeById(id);
    }
    ...
    public Consumer selectByPrimaryKey(Integer id){
        return iConsumerService.getById(id);
    }
    ...
    public Object login(HttpServletRequest request){
        ...
        if(consumerTemp!=null){   //验证成功
            ...
            jsonObject.put("userMsg",iConsumerService.getOne(queryWrapperTwo));//登陆成功返回用户的信息
            return jsonObject;
        }
        jsonObject.put(Consts.CODE,0);
