...
// 删除歌手
export const removeSinger = (params) => post('singer/delete', params);
...
//编辑歌单
export const updateList = (params) => post(`songList/update`, params);
//删除歌单
...
export const delListSong = (songId, songListId) =>
	get(`songListMusic/delete?songId=${songId}&songListId=${songListId}`);
...
//删除用户
export const delUser = (id) => get(`consumer/delete?id=${id}`);
//根据用户id查询该用户的详细信息
