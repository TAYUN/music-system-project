<template>
	<!-- 歌单管理页面 -->
	<div class="table">
		<div class="crumbs"><i class="el-icon-s-fold"></i>&nbsp;歌单管理</div>
		<div class="container">
		...
		<el-dialog title="修改歌单" :visible.sync="editVisible" width="400px" center>
			<el-form :model="compileForm" ref="form" label-width="80px">
				<el-form-item prop="title" label="标题" size="mini">
					<el-input v-model="compileForm.rubric" placeholder="标题"></el-input>
				</el-form-item>
				<el-form-item prop="introduction" label="简介" size="mini">
					<el-input
						v-model="compileForm.describe"
						placeholder="简介"
						type="textarea"></el-input>
				</el-form-item>
				<el-form-item prop="style" label="风格" size="mini">
					<el-input v-model="compileForm.class" placeholder="风格"></el-input>
				</el-form-item>
			</el-form>
			<span slot="footer">
				<el-button size="mini" @click="editVisible = false">取消</el-button>
				<el-button size="mini" @click="compile">确定</el-button>
			</span>
		</el-dialog>
...
<script>
import { getAllSongList, setSongList, updateList, delSongList } from '../api/index';
...
export default {
	...
	methods: {
		...
		compile() {
			...
			query.append('id', this.compileForm.ListNo);
			query.append('title', this.compileForm.rubric);
			query.append('introduction', this.compileForm.describe);
			query.append('style', this.compileForm.class);
		...
		//转向歌曲管理页面
		songEdit(id, name) {
			this.$router.push({ path: `/SongListMusic`, query: { id } });
		},
